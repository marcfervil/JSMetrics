Vue.component('about', {
   ...
   template: `
      <div class="metricsContent aboutContent" style="background-color:#1e1e1e">
            ...
            <div style="grid-column:2;">
               ...
               <div class="bubble autoSize about">
                  ...
                  Cyclomatic complexity, and WMC.  JSMetrics also provides graphs that allows the user compare and contrast various metrics.
